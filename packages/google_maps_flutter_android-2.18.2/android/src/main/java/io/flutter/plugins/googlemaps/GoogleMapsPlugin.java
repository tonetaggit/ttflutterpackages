...
public class GoogleMapsPlugin implements FlutterPlugin, ActivityAware {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    // Initialize performance utilities with application context
    // This determines optimal batch sizes based on device memory
    PerformanceUtils.initialize(binding.getApplicationContext());
